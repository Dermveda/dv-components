...
storiesOf('Molecules/Section', module)
		...
		withReadme(SectionReadme, () => {
			...
			return (
				<Section
					...
					Duis sit amet sem mi. Maecenas aliquam, orci in imperdiet dapibus, tellus metus sodales dolor, et tempus lacus eros eget dolor.
					Etiam quis metus commodo, rhoncus velit ultrices, pharetra nisl.
				</Section>
			);
		})
	)
	...
	.add('circle section skeleton loading', () => {
		const createSkeletonWrapper = props => <CircleSection {...props} />;
