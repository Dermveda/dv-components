...
const TileFeatured = ({ articles, description, renderFooter, footerProps, headerAttributes, ...props }) => {
	...
	return (
		<Section centered content {...props} buttonAttributes={buttonAttributes}>
			...
			<ArticleRowList articles={articles} renderFooter={renderFooter} footerProps={footerProps} />
		</Section>
	);
};
